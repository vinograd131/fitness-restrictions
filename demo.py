...
Сам продукт — это API (src/serve.py), витрина только для демонстрации.
TODO: в проде разнести на два интерфейса — форму клиента и кабинет тренера.
...
]  # примеры для демонстрации, в проде не нужны
